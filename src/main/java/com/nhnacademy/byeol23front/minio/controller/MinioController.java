...
public class MinioController {
	...
	// 	}
	// 	//TODO file 검사로직
	// 	String url = minioUtil.putObject(uploadImageRequest.imageDomain(), uploadImageRequest.id(), file);
	// 	//TODO DB저장(이벤트로 처리)
	// 	//DB저장 실패시 삭제로직
	// 	if(false){
	// 		try {
	// 			minioUtil.deleteObject(uploadImageRequest.imageDomain(), uploadImageRequest.id());
	// 		} catch (Exception e) {
	...
	// ) {
	// 	minioUtil.deleteObject(request.imageDomain(), request.id());
